...
public class Remove extends AppCompatActivity {
    ...
    public void remove(View view) {
        ...
        if (empid.isEmpty())
        {
            ...
            new Remove.AsyncRemove().execute(empid);
        }
    }

    private class AsyncRemove extends AsyncTask<String, String, String>
    {
        ProgressDialog pdLoading = new ProgressDialog(Remove.this);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("https://karthikselvann.000webhostapp.com/Remove.php");
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equalsIgnoreCase("true"))
            {
                ...
                Toast.makeText(Remove.this, "Success", Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(Remove.this, "Something Wrong", Toast.LENGTH_LONG).show();

            } else {

                Toast.makeText(Remove.this, result, Toast.LENGTH_LONG).show();
