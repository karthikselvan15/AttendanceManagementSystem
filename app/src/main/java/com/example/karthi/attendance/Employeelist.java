...
public class Employeelist extends AppCompatActivity {
    ...
    {
        ProgressDialog pdLoading = new ProgressDialog(Employeelist.this);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("https://karthikselvann.000webhostapp.com/EmployeeList.php");
        ...
        protected void onPostExecute(String result) {
            ...
            if (!result.equalsIgnoreCase("false"))
                try {
                    ...
                    final String IdList[] = new String[jsonarray.length()];
                    ...
                    CustomAdapter customAdapter = new CustomAdapter(getApplicationContext(), IdList, NameList);
                    ...
                    simpleList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            intent.putExtra("EmpId", IdList[position]);
